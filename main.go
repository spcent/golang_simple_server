...
func main() {
	...
	mux.HandleFunc("/", middleware.ApplyMiddleware(router.Handle, middleware.LoggingMiddleware, middleware.AuthMiddleware))
	mux.HandleFunc("/ping", pingHandler)
	mux.HandleFunc("/hello", middleware.ApplyMiddleware(helloHandler, middleware.LoggingMiddleware))
